...
<form action="productsController" method="get">
    ...
    <input type="hidden" name="action" value="sport">
    <select name="sort">
...
<c:forEach items="${list}" var="product">
    <c:if test="${product.getCategory() == 'sport' }">
        <div class="table-users">
            <div class="header">Sport Product ID: ${product.getId()}</div>
            <table style="width:100%" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <a href="productsController?page=addToCart&action=sport&id=<c:out value="${product.getId()}"/>">Add
                            to
                            Cart</a></td>
                </tr>
            </table>
